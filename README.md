...
- Insert your own Ubuntu IP address on this line of code: ftp = FTP("YOUR_UBUNTU_IP")
- Insert your own Ubuntu credentials on this line of code: ftp.login("UBUNTU_USERNAME", "PASSWORD")
